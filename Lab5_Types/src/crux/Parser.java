...
public class Parser {
    ...
    private types.Type tryResolveType(String typeStr)
    {
        return types.Type.getBaseType(typeStr);
    }
    ...
    private void initSymbolTable()
    {
        ...
        sym.setType(types.Type.getBaseType("int"));
        sym = symbolTable.insert("readFloat");
        sym.setType(types.Type.getBaseType("float"));
        sym =symbolTable.insert("printBool");
        sym.setType(types.Type.getBaseType("void"));
    ...
    public ast.Expression expression0()
    {
        ...
        if (have(NonTerminal.OP0)) {
            ...
            exp = left_exp =  ast.Command.newExpression(left_exp, tok, right_exp);
    ...
    public ast.Expression expression3()
    {
        ...
        if (have(Token.Kind.NOT)) {
            ...
            exp = ast.Command.newExpression(left_exp, tok, null);
    ...
    public types.TypeList parameter_list() {
        types.TypeList tl = new types.TypeList();
    ...
    public ast.Declaration function_definition() {
        ...
        types.TypeList tl = parameter_list();
