...
public class Token {
	...
	public static enum Kind {
		...
		//           can report whether a crux.Token.Kind has the given lexeme
	}
	...
	public String toString()
	{
		// TODO: implement this
		String output;
		if (kind == Kind.IDENTIFIER || kind == Kind.INTEGER || kind == Kind.FLOAT || kind == Kind.ERROR) {
	...
	//           boolean is(crux.Token.Kind kind)
